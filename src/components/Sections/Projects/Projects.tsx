    ...
    const projectsArray: IProjectCard[] = [
      {
        ...
        description:
          "Core Java GUI application for handling hotel bookings, customer records, billing and room allocation.",
      ...
      },
      {
        ...
        description:
          "Autonomous robotic car using Arduino and ultrasonic sensors to detect and avoid obstacles.",
      ...
      },
      {
        ...
        description:
          "Full-stack web application built with React.js & Node.js for managing campus events and registrations.",
      ...
      //   description:
      //     "Python-based AI model for detecting and interpreting sign language using computer vision.",
      //   img: "/images/sign-language.jpg",
      //   siteUrl: "#",
      //   repoUrl: "#"
      // },
      {
        ...
        description:
          "Mobile application for tracking expenses, budgeting and financial insights.",
